...
h0 = 60;
MORparam.hy = h0 * ones(1,length(MORparam.y));
ihill = MORparam.y<=3250+MORparam.y0&MORparam.y>=2750+MORparam.y0;
MORparam.hy(ihill) = 47.5-12.5*cos(2*pi*MORparam.y(ihill)/500);
